...
class GoogleBase:
    def __init__(self, project_id='css-operations', oauth_file=None, svc_account_file=None, svc_account_info=None, ds_secret='brand_science_svc_account', scopes=None):
        ...
        if oauth_file:
            ...
            self.creds = service_account.Credentials.from_service_account_file(svc_account_file, scopes=scopes)
        elif svc_account_info:
            self.creds = service_account.Credentials.from_service_account_info(svc_account_info, scopes=scopes)
        elif ds_secret:
